...
public class WebQueryEngine {
    ...
    public Collection<Page> query(String query) {
        ...
        // Create the post-fix stack, then compute the stack using the index
        return QueryProcessor.queryPages(QueryProcessor.createQueryStack(query), currentIndex);
    }
}
